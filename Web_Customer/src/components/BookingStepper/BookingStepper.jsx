...
const cinemaFirstSteps = [
  { num: 1, label: 'Chọn rạp', icon: 'R' },
  { num: 2, label: 'Chọn phim', icon: 'P' },
  { num: 3, label: 'Suất chiếu', icon: 'S' },
  { num: 4, label: 'Chọn ghế', icon: 'G' },
  { num: 5, label: 'Đồ ăn', icon: 'D' },
  { num: 6, label: 'Thanh toán', icon: 'T' },
];

const movieFirstSteps = [
  { num: 1, label: 'Chọn phim', icon: 'P' },
  { num: 2, label: 'Chọn rạp', icon: 'R' },
  { num: 3, label: 'Suất chiếu', icon: 'S' },
  { num: 4, label: 'Chọn ghế', icon: 'G' },
  { num: 5, label: 'Đồ ăn', icon: 'D' },
  { num: 6, label: 'Thanh toán', icon: 'T' },
